...
let HomePage = class HomePage {
    constructor(storageService) {
        ...
        this.accounts = [];
        this.accountState = { income: 0, expense: 0, totalBalance: 0 };
        this.features = [];
        this.transactions = [];
...
module.exports = "ion-header ion-toolbar {\n  --padding-start: 16px;\n  --padding-end: 16px;\n}\nion-header ion-toolbar ion-title {\n  max-width: 40vh;\n}\nion-header ion-toolbar ion-title ion-label ion-text {\n  font-size: 13px;\n}\nion-header ion-toolbar ion-title ion-label p ion-text {\n  font-size: 1.3rem !important;\n}\nion-header ion-toolbar ion-avatar {\n  height: 2.5rem;\n  width: 2.5rem;\n  border: 1px solid var(--ion-color-tertiary);\n}\nion-header ion-toolbar ion-avatar img {\n  max-width: 100%;\n}\nion-content ion-row.banners {\n  position: relative;\n  padding: 1.5rem;\n  height: 22vh;\n  background: linear-gradient(120.67deg, #03b5aa 17.45%, rgba(162, 167, 127, 0.09) 105.58%);\n  border-radius: 1rem;\n  margin: 6vh 1rem 0 1rem;\n}\nion-content ion-row.banners swiper div ion-label p.acc-amt {\n  margin: 1rem 0;\n  font-size: 3rem;\n  font-weight: 700;\n}\nion-content ion-row.banners::after {\n  content: \"\";\n  position: absolute;\n  top: 1px;\n  left: 1px;\n  right: 1px;\n  bottom: 1px;\n  background: #194648;\n  border-radius: 1rem;\n  z-index: 0;\n  border: 2px solid transparent;\n}\nion-content ion-row.feature-list {\n  padding: 5vh 0;\n}\nion-content ion-row.feature-list div {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\nion-content ion-row.feature-list div ion-button {\n  --border-radius: 15px;\n  height: 8vh;\n}\nion-content ion-row.feature-list div ion-label {\n  font-size: 13px;\n}\nion-content .segment-content {\n  background: var(--ion-card-background);\n  margin-top: -16px;\n}\nion-content ion-list.transactions {\n  background: transparent;\n  padding-bottom: 10vh;\n}\nion-content ion-list.transactions ion-list-header {\n  padding-inline-start: 2vh;\n}\nion-content ion-list.transactions ion-list-header ion-label,\nion-content ion-list.transactions ion-item ion-label {\n  font-size: 0.8rem;\n}\nion-content ion-list.transactions .transaction-group {\n  padding: 0 2vh;\n}\nion-content ion-list.transactions .transaction-group .date-list {\n  --border-color: var(--ion-color-warning);\n}\nion-content ion-list.transactions .transaction-group ion-item {\n  font-weight: bold;\n  --background: transparent;\n  --padding-start: 8px;\n  margin-bottom: 3px;\n}\nion-content ion-list.transactions .transaction-group ion-item ion-text[slot=end] {\n  font-size: 12px;\n  font-weight: 500;\n}\nion-content ion-list.transactions .transaction-group ion-item p {\n  font-size: 0.9rem;\n  font-weight: normal;\n  margin-top: 3px;\n}\nion-content ion-list.transactions .transaction-group ion-item ion-thumbnail {\n  display: flex;\n  gap: 6px;\n  font-size: 14px;\n  align-items: center;\n  height: 100%;\n}\nion-content ion-list.transactions .transaction-group ion-item ion-thumbnail .trans-day {\n  background: var(--ion-color-tertiary);\n  font-size: 10px;\n  border-radius: 3px;\n  padding: 2px;\n}\nion-content ion-list.transactions .transaction-group ion-item ion-thumbnail .trans-year {\n  font-size: 10px;\n  color: var(--ion-color-medium);\n}\nion-content ion-list.transactions .transaction-group ion-item .trans-time {\n  font-size: 10px;\n  color: var(--ion-color-medium);\n}\nion-content ion-list.transactions .transaction-group ion-item .trans-cat {\n  font-size: 10px;\n  color: var(--ion-color-medium);\n  margin-right: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "<ion-header class=\"ion-no-border\">\n  <ion-toolbar color=\"light\">\n    <ion-title mode=\"md\" class=\"ion-no-padding\">\n      <ion-label>\n        <ion-text color=\"warning\">Welcome</ion-text>\n        <!-- <p>\n          <ion-text color=\"white\"><strong>Nikhil Ag.</strong></ion-text>\n        </p> -->\n      </ion-label>\n    </ion-title>\n    <!-- <ion-avatar slot=\"end\">\n      <img src=\"assets/imgs/img.png\" />\n    </ion-avatar> -->\n  </ion-toolbar>\n</ion-header>\n\n<ion-content color=\"light\">\n  <!-- <ion-row class=\"banners\">\n  <swiper [config]=\"bannerConfig\">\n      <ng-template swiperSlide *ngFor=\"let account of accounts\">\n        <div align=\"center\">\n          <ion-label>\n            <span>Total Balance</span>\n            <p class=\"acc-amt\">\n              <ion-text color=\"white\">₹{{account?.balance}}</ion-text>\n            </p>\n            <span>{{account?.name}}</span>\n          </ion-label>\n        </div>\n      </ng-template>\n    </swiper> \n  </ion-row>-->\n  <ion-card>\n    <ion-card-header>\n      <ion-card-title class=\"ion-text-center\"\n        >{{1221 | currency:'INR'}}</ion-card-title\n      >\n      <ion-card-subtitle class=\"ion-text-center ion-margin-top\"\n        >Total Balance</ion-card-subtitle\n      >\n    </ion-card-header>\n\n    <ion-card-content>\n      <ion-row>\n        <ion-col size=\"4\" class=\"ion-text-center\">\n          <ion-label>Income</ion-label>\n          <div>\n            <ion-text color=\"success\"> {{100 | currency:'INR'}}</ion-text>\n          </div>\n        </ion-col>\n        <ion-col size=\"4\" class=\"ion-text-center\">\n          <ion-label>Expence</ion-label>\n          <div>\n            <ion-text color=\"danger\"> {{100 | currency:'INR'}}</ion-text>\n          </div>\n        </ion-col>\n        <ion-col size=\"4\" class=\"ion-text-center\">\n          <ion-label>Total</ion-label>\n          <div>\n            <ion-text color=\"white\"> {{100 | currency:'INR'}}</ion-text>\n          </div>\n        </ion-col>\n      </ion-row>\n    </ion-card-content>\n  </ion-card>\n\n  <div class=\"ion-padding-top\">\n    <ion-segment value=\"day\" [(ngModel)]=\"selectedView\" color=\"warning\">\n      <ion-segment-button value=\"day\">\n        <ion-label>Day</ion-label>\n      </ion-segment-button>\n      <ion-segment-button value=\"calender\">\n        <ion-label>Calender</ion-label>\n      </ion-segment-button>\n      <ion-segment-button value=\"segment\">\n        <ion-label>Month</ion-label>\n      </ion-segment-button>\n      <ion-segment-button value=\"total\">\n        <ion-label>Total</ion-label>\n      </ion-segment-button>\n    </ion-segment>\n    <div [ngSwitch]=\"selectedView\" class=\"segment-content\">\n      <ion-list *ngSwitchCase=\"'day'\" class=\"transactions ion-margin-top\">\n        <ion-list-header>\n          <ion-label color=\"medium\">Transactions</ion-label>\n        </ion-list-header>\n\n        <ion-item-group class=\"transaction-group\">\n          <ng-container *ngFor=\"let transaction of transactions\">\n            <ion-item lines=\"full\" class=\"date-list\">\n              <ion-thumbnail slot=\"start\">\n                {{transaction.date | date: 'd'}}\n                <span class=\"trans-day\">{{transaction.date | date:'EE'}}</span>\n                <span class=\"trans-year\"\n                  >{{transaction.date | date:'LL.y'}}</span\n                >\n              </ion-thumbnail>\n\n              <ion-text slot=\"end\" color=\"success\">\n                {{transaction?.income| currency:'INR'}}\n              </ion-text>\n              <ion-text slot=\"end\" color=\"danger\">\n                {{transaction?.expense | currency:'INR'}}\n              </ion-text>\n            </ion-item>\n            <ion-item-group>\n              <ion-item\n                lines=\"full\"\n                *ngFor=\"let tr of transaction.transaction\"\n                color=\"light\"\n              >\n                <ion-thumbnail class=\"trans-cat\">\n                  {{tr.category}}</ion-thumbnail\n                >\n                <div>\n                  <ion-label> {{tr.note}} </ion-label>\n                  <ion-text class=\"trans-time\">\n                    {{tr.date | date:'hh:mm a'}}\n                  </ion-text>\n                </div>\n                <ion-text\n                  slot=\"end\"\n                  [color]=\"tr?.amount >= 0 ? 'success' : 'danger'\"\n                >\n                  {{tr?.amount | currency:'INR'}}\n                </ion-text>\n              </ion-item>\n            </ion-item-group>\n          </ng-container>\n        </ion-item-group>\n      </ion-list>\n    </div>\n  </div>\n  <!-- <ion-row class=\"ion-text-center feature-list\" *ngIf=\"features?.length > 0\">\n    <swiper [config]=\"featureConfig\">\n      <ng-template swiperSlide *ngFor=\"let feature of features\">\n        <div>\n          <ion-button\n            slot=\"icon-only\"\n            [color]=\"feature?.color\"\n            [routerLink]=\"['/tabs',feature?.name.toLowerCase()]\"\n          >\n            <ion-icon [name]=\"feature?.icon\"></ion-icon>\n          </ion-button>\n          <ion-label>{{feature?.name}}</ion-label>\n        </div>\n      </ng-template>\n    </swiper>\n  </ion-row> -->\n\n  <ion-fab slot=\"fixed\" vertical=\"bottom\" horizontal=\"end\">\n    <ion-fab-button color=\"warning\">\n      <ion-icon name=\"add\"></ion-icon>\n    </ion-fab-button>\n    <ion-fab-list side=\"top\">\n      <ion-fab-button color=\"danger\">\n        <ion-icon name=\"trending-down-outline\"></ion-icon>\n      </ion-fab-button>\n      <ion-fab-button color=\"success\">\n        <ion-icon name=\"trending-up-outline\"></ion-icon>\n      </ion-fab-button>\n    </ion-fab-list>\n  </ion-fab>\n</ion-content>\n";
