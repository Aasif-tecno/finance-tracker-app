...
/***/ 9785:
/*!******************************************!*\
  !*** ./src/app/services/default-data.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _default_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./default-data */ 9785);
...
let StorageService = class StorageService {
    ...
    createDefaultData() {
        var _a;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            const storedAccounts = yield ((_a = this.storage) === null || _a === void 0 ? void 0 : _a.length());
            console.log('🚀 ~ file: storage.service.ts:21 ~ StorageService ~ createDefaultData ~ storedAccounts', storedAccounts);
            if (storedAccounts === 0) {
                this.storage.set('accounts', _default_data__WEBPACK_IMPORTED_MODULE_1__.accounts);
            }
        });
    }
    get(key) {
    ...
    addData(key, value) {
        var _a, _b;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            const storedData = (yield ((_a = this.storage) === null || _a === void 0 ? void 0 : _a.get(key))) || [];
            storedData.push(value);
            return (_b = this.storage) === null || _b === void 0 ? void 0 : _b.set(key, storedData);
        });
    }
    editData(key, index, value) {
        var _a, _b;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            const storedData = (yield ((_a = this.storage) === null || _a === void 0 ? void 0 : _a.get(key))) || [];
